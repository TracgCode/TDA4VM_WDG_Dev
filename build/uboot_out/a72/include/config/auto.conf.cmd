...
ifneq "$(CC_VERSION_TEXT)" "aarch64-none-linux-gnu-gcc (Arm GNU Toolchain 11.3.Rel1) 11.3.1 20220712"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "/home/james/ti-processor-sdk-linux-adas-j721e-evm-09_00_01_03/board-support/u-boot-2023.04+gitAUTOINC+bd74e615a6-gbd74e615a6"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "~/ti/arm-gnu-toolchain-11.3.rel1-x86_64-aarch64-none-linux-gnu/bin/aarch64-none-linux-gnu-gcc"
include/config/auto.conf: FORCE
endif
